...
The R^2 of training was **0.24** and the R^2 for testing was **0.25**. The RMSE for training was **20.60** and the RMSE for testing was **20.71**. These low metric scores, lets us know that we need to improve our model and that there possibly could be better features that we could utilize to make our predictions more accurate.
